...
public abstract class AbstractExtendedSingleThreadLevel implements ExtendedComparisonLevel {
    ...
    public ExtendedPartialResult compare(SourceCode sourceCode1, SourceCode sourceCode2) {
        ...
        return new ExtendedPartialResult(
                ...
                new StringListSourceCode(text1),
                new StringListSourceCode(text2)
        );
    }
